...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class TenantSettingsV2BusinessUnitTenantResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \CompWright\ServiceTitan\Model\TenantSettingsV2BusinessUnitTenantResponse::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \CompWright\ServiceTitan\Model\TenantSettingsV2BusinessUnitTenantResponse::class;
        }
        ...
        {
            return [\CompWright\ServiceTitan\Model\TenantSettingsV2BusinessUnitTenantResponse::class => false];
        }
    }
} else {
    class TenantSettingsV2BusinessUnitTenantResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
