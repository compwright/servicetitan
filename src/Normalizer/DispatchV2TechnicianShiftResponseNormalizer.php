...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class DispatchV2TechnicianShiftResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \CompWright\ServiceTitan\Model\DispatchV2TechnicianShiftResponse::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \CompWright\ServiceTitan\Model\DispatchV2TechnicianShiftResponse::class;
        }
        ...
        {
            return [\CompWright\ServiceTitan\Model\DispatchV2TechnicianShiftResponse::class => false];
        }
    }
} else {
    class DispatchV2TechnicianShiftResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
