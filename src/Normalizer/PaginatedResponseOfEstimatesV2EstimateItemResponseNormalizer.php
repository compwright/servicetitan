...
class PaginatedResponseOfEstimatesV2EstimateItemResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'CompWright\\ServiceTitan\\Model\\PaginatedResponseOfEstimatesV2EstimateItemResponse';
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'CompWright\\ServiceTitan\\Model\\PaginatedResponseOfEstimatesV2EstimateItemResponse';
    }
