...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class PricebookV2ServiceBulkCreateRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \CompWright\ServiceTitan\Model\PricebookV2ServiceBulkCreateRequest::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \CompWright\ServiceTitan\Model\PricebookV2ServiceBulkCreateRequest::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \CompWright\ServiceTitan\Model\PricebookV2ServiceBulkCreateRequest();
            ...
            if (\array_key_exists('serviceEquipment', $data) && $data['serviceEquipment'] !== null) {
                ...
                foreach ($data['serviceEquipment'] as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, \CompWright\ServiceTitan\Model\PricebookV2SkuLinkBulkCreateRequest::class, 'json', $context);
                }
            ...
            if (\array_key_exists('recommendations', $data) && $data['recommendations'] !== null) {
                ...
                foreach ($data['recommendations'] as $value_2) {
                    $values_2[] = $this->denormalizer->denormalize($value_2, \CompWright\ServiceTitan\Model\PricebookV2ServiceRecommendationBulkCreateRequest::class, 'json', $context);
                }
            ...
            if (\array_key_exists('upgrades', $data) && $data['upgrades'] !== null) {
                ...
                foreach ($data['upgrades'] as $value_3) {
                    $values_3[] = $this->denormalizer->denormalize($value_3, \CompWright\ServiceTitan\Model\PricebookV2SkuUpgradeBulkCreateRequest::class, 'json', $context);
                }
        ...
        {
            return [\CompWright\ServiceTitan\Model\PricebookV2ServiceBulkCreateRequest::class => false];
        }
    }
} else {
    class PricebookV2ServiceBulkCreateRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
