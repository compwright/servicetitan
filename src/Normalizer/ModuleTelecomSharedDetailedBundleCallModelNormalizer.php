...
class ModuleTelecomSharedDetailedBundleCallModelNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'CompWright\\ServiceTitan\\Model\\ModuleTelecomSharedDetailedBundleCallModel';
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'CompWright\\ServiceTitan\\Model\\ModuleTelecomSharedDetailedBundleCallModel';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (\array_key_exists('leadCall', $data)) {
            $object->setLeadCall($this->denormalizer->denormalize($data['leadCall'], 'CompWright\\ServiceTitan\\Model\\ModuleTelecomSharedDetailedCallModel', 'json', $context));
        }
