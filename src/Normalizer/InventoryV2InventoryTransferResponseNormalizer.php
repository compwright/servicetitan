...
class InventoryV2InventoryTransferResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'CompWright\\ServiceTitan\\Model\\InventoryV2InventoryTransferResponse';
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'CompWright\\ServiceTitan\\Model\\InventoryV2InventoryTransferResponse';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (\array_key_exists('items', $data)) {
            ...
            foreach ($data['items'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'CompWright\\ServiceTitan\\Model\\InventoryV2InventoryTransferItemResponse', 'json', $context);
            }
    ...
    public function normalize($object, $format = null, array $context = [])
    {
        ...
        if (null !== $object->getPickedDate()) {
            $data['pickedDate'] = $object->getPickedDate()->format('Y-m-d\\TH:i:sP');
        }
        if (null !== $object->getReceivedDate()) {
