...
class ModuleAdminSharedBusinessUnitTenantModelNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'CompWright\\ServiceTitan\\Model\\ModuleAdminSharedBusinessUnitTenantModel';
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'CompWright\\ServiceTitan\\Model\\ModuleAdminSharedBusinessUnitTenantModel';
    }
