...
class EquipmentSystemsV2InstalledEquipmentDetailedResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'CompWright\\ServiceTitan\\Model\\EquipmentSystemsV2InstalledEquipmentDetailedResponse';
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'CompWright\\ServiceTitan\\Model\\EquipmentSystemsV2InstalledEquipmentDetailedResponse';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (\array_key_exists('customFields', $data) && $data['customFields'] !== null) {
            ...
            foreach ($data['customFields'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'CompWright\\ServiceTitan\\Model\\EquipmentSystemsV2CustomFieldResponseModel', 'json', $context);
            }
