...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class PricebookV2PricebookBulkCreateResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \CompWright\ServiceTitan\Model\PricebookV2PricebookBulkCreateResponse::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \CompWright\ServiceTitan\Model\PricebookV2PricebookBulkCreateResponse::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \CompWright\ServiceTitan\Model\PricebookV2PricebookBulkCreateResponse();
            ...
            if (\array_key_exists('services', $data) && $data['services'] !== null) {
                ...
                foreach ($data['services'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, \CompWright\ServiceTitan\Model\PricebookV2CustomIdMappingModel::class, 'json', $context);
                }
            ...
            if (\array_key_exists('equipment', $data) && $data['equipment'] !== null) {
                ...
                foreach ($data['equipment'] as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, \CompWright\ServiceTitan\Model\PricebookV2CustomIdMappingModel::class, 'json', $context);
                }
            ...
            if (\array_key_exists('materials', $data) && $data['materials'] !== null) {
                ...
                foreach ($data['materials'] as $value_2) {
                    $values_2[] = $this->denormalizer->denormalize($value_2, \CompWright\ServiceTitan\Model\PricebookV2CustomIdMappingModel::class, 'json', $context);
                }
            ...
            if (\array_key_exists('discountAndFees', $data) && $data['discountAndFees'] !== null) {
                ...
                foreach ($data['discountAndFees'] as $value_3) {
                    $values_3[] = $this->denormalizer->denormalize($value_3, \CompWright\ServiceTitan\Model\PricebookV2CustomIdMappingModel::class, 'json', $context);
                }
        ...
        {
            return [\CompWright\ServiceTitan\Model\PricebookV2PricebookBulkCreateResponse::class => false];
        }
    }
} else {
    class PricebookV2PricebookBulkCreateResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
