...
class PricebookV2PricebookBulkCreateResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'CompWright\\ServiceTitan\\Model\\PricebookV2PricebookBulkCreateResponse';
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'CompWright\\ServiceTitan\\Model\\PricebookV2PricebookBulkCreateResponse';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (\array_key_exists('services', $data) && $data['services'] !== null) {
            ...
            foreach ($data['services'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'CompWright\\ServiceTitan\\Model\\PricebookV2CustomIdMappingModel', 'json', $context);
            }
        ...
        if (\array_key_exists('equipment', $data) && $data['equipment'] !== null) {
            ...
            foreach ($data['equipment'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, 'CompWright\\ServiceTitan\\Model\\PricebookV2CustomIdMappingModel', 'json', $context);
            }
        ...
        if (\array_key_exists('materials', $data) && $data['materials'] !== null) {
            ...
            foreach ($data['materials'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'CompWright\\ServiceTitan\\Model\\PricebookV2CustomIdMappingModel', 'json', $context);
            }
        ...
        if (\array_key_exists('discountAndFees', $data) && $data['discountAndFees'] !== null) {
            ...
            foreach ($data['discountAndFees'] as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, 'CompWright\\ServiceTitan\\Model\\PricebookV2CustomIdMappingModel', 'json', $context);
            }
