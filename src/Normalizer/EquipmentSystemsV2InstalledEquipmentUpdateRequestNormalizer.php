...
class EquipmentSystemsV2InstalledEquipmentUpdateRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'CompWright\\ServiceTitan\\Model\\EquipmentSystemsV2InstalledEquipmentUpdateRequest';
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'CompWright\\ServiceTitan\\Model\\EquipmentSystemsV2InstalledEquipmentUpdateRequest';
    }
