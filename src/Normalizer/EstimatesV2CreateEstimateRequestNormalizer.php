...
class EstimatesV2CreateEstimateRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'CompWright\\ServiceTitan\\Model\\EstimatesV2CreateEstimateRequest';
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'CompWright\\ServiceTitan\\Model\\EstimatesV2CreateEstimateRequest';
    }
