...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class CrmV2AppointmentInformationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \CompWright\ServiceTitan\Model\CrmV2AppointmentInformation::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \CompWright\ServiceTitan\Model\CrmV2AppointmentInformation::class;
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \CompWright\ServiceTitan\Model\CrmV2AppointmentInformation();
            ...
            if (\array_key_exists('technicianIds', $data) && $data['technicianIds'] !== null) {
                $values = [];
                foreach ($data['technicianIds'] as $value) {
                    $values[] = $value;
                }
                $object->setTechnicianIds($values);
            } elseif (\array_key_exists('technicianIds', $data) && $data['technicianIds'] === null) {
                $object->setTechnicianIds(null);
            }
        ...
        public function normalize(mixed $object, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('technicianIds') && null !== $object->getTechnicianIds()) {
                $values = [];
        ...
        {
            return [\CompWright\ServiceTitan\Model\CrmV2AppointmentInformation::class => false];
        }
    }
} else {
    class CrmV2AppointmentInformationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
