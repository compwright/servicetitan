...
class InventoryV2InventoryReceiptItemResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'CompWright\\ServiceTitan\\Model\\InventoryV2InventoryReceiptItemResponse';
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'CompWright\\ServiceTitan\\Model\\InventoryV2InventoryReceiptItemResponse';
    }
