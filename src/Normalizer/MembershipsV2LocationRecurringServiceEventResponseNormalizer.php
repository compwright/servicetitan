...
class MembershipsV2LocationRecurringServiceEventResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'CompWright\\ServiceTitan\\Model\\MembershipsV2LocationRecurringServiceEventResponse';
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'CompWright\\ServiceTitan\\Model\\MembershipsV2LocationRecurringServiceEventResponse';
    }
    ...
    public function normalize($object, $format = null, array $context = [])
    {
        ...
        if (null !== $object->getLocationRecurringServiceName()) {
        ...
        if (null !== $object->getMembershipName()) {
