...
class PaginatedResponseOfPricebookV2CategoryResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'CompWright\\ServiceTitan\\Model\\PaginatedResponseOfPricebookV2CategoryResponse';
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'CompWright\\ServiceTitan\\Model\\PaginatedResponseOfPricebookV2CategoryResponse';
    }
