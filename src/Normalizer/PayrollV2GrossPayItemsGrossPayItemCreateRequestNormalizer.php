...
class PayrollV2GrossPayItemsGrossPayItemCreateRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'CompWright\\ServiceTitan\\Model\\PayrollV2GrossPayItemsGrossPayItemCreateRequest';
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'CompWright\\ServiceTitan\\Model\\PayrollV2GrossPayItemsGrossPayItemCreateRequest';
    }
