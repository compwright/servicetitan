...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class TaskManagementV2SubtaskCreateRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \CompWright\ServiceTitan\Model\TaskManagementV2SubtaskCreateRequest::class;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \CompWright\ServiceTitan\Model\TaskManagementV2SubtaskCreateRequest::class;
        }
        ...
        {
            return [\CompWright\ServiceTitan\Model\TaskManagementV2SubtaskCreateRequest::class => false];
        }
    }
} else {
    class TaskManagementV2SubtaskCreateRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
