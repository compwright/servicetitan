...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api-integration.servicetitan.io/telecom/v2';
    ...
    {
        $report  = 'PHP SDK (CompWright\ServiceTitan) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://api-integration.servicetitan.io/telecom/v2",
