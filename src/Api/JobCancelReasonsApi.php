...
class JobCancelReasonsApi
{
     ...
     * @param  OneOfActiveQueryFilter $active What kind of items should be returned (active and inactive items will be returned by default)\\ Values: [True, Any, False] (optional)
     *
     ...
     */
    public function jobCancelReasonsGetList($tenant, $page = null, $page_size = null, $include_total = null, $active = null)
    {
        list($response) = $this->jobCancelReasonsGetListWithHttpInfo($tenant, $page, $page_size, $include_total, $active);
        return $response;
    }
     ...
     */
    public function jobCancelReasonsGetListWithHttpInfo($tenant, $page = null, $page_size = null, $include_total = null, $active = null)
    {
        $request = $this->jobCancelReasonsGetListRequest($tenant, $page, $page_size, $include_total, $active);
     ...
     */
    public function jobCancelReasonsGetListAsync($tenant, $page = null, $page_size = null, $include_total = null, $active = null)
    {
        return $this->jobCancelReasonsGetListAsyncWithHttpInfo($tenant, $page, $page_size, $include_total, $active)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function jobCancelReasonsGetListAsyncWithHttpInfo($tenant, $page = null, $page_size = null, $include_total = null, $active = null)
    {
        $returnType = '\CompWright\ServiceTitan\Model\PaginatedResponseOfCrmV2JobCancelReasonResponse';
        $request = $this->jobCancelReasonsGetListRequest($tenant, $page, $page_size, $include_total, $active);
     ...
     */
    public function jobCancelReasonsGetListRequest($tenant, $page = null, $page_size = null, $include_total = null, $active = null)
    {
