...
class AppointmentAssignmentsUnassignTechnicians extends \CompWright\ServiceTitan\Runtime\Client\BaseEndpoint implements \CompWright\ServiceTitan\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(int $tenant, ?\CompWright\ServiceTitan\Model\CrmV2UnassignTechniciansRequest $requestBody = null)
    {
        $this->tenant = $tenant;
    ...
    {
        return str_replace(['{tenant}'], [$this->tenant], '/dispatch/v2/tenant/{tenant}/appointment-assignments/unassign-technicians');
    }

    public function getBody(\Symfony\Component\Serializer\SerializerInterface $serializer, $streamFactory = null): array
    {
        if ($this->body instanceof \CompWright\ServiceTitan\Model\CrmV2UnassignTechniciansRequest) {
