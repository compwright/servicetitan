...
class CampaignsCreate extends \CompWright\ServiceTitan\Runtime\Client\BaseEndpoint implements \CompWright\ServiceTitan\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(int $tenant, ?\CompWright\ServiceTitan\Model\MarketingV2CampaignUpsertRequest $requestBody = null)
    {
        $this->tenant = $tenant;
