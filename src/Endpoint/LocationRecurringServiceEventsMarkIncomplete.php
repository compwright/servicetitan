...
class LocationRecurringServiceEventsMarkIncomplete extends \CompWright\ServiceTitan\Runtime\Client\BaseEndpoint implements \CompWright\ServiceTitan\Runtime\Client\Endpoint
{
    ...
    {
        return str_replace(['{id}', '{tenant}'], [$this->id, $this->tenant], '/memberships/v2/tenant/{tenant}/recurring-service-events/{id}/mark-incomplete');
    }
