...
class JpmClient extends Runtime\Client\Client
{
    /**
     ...
     *
     * @throws Exception\AppointmentsDeleteBadRequestException
     * @throws Exception\AppointmentsDeleteNotFoundException
     * @throws Exception\AppointmentsDeleteConflictException
     */
    public function appointmentsDelete(int $id, int $tenant, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new Endpoint\AppointmentsDelete($id, $tenant), $fetch);
    }
     ...
     *
     * @throws Exception\AppointmentsGetBadRequestException
     * @throws Exception\AppointmentsGetNotFoundException
     */
    public function appointmentsGet(int $id, int $tenant, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new Endpoint\AppointmentsGet($id, $tenant), $fetch);
    }
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return Model\PaginatedResponseOfCrmV2AppointmentResponse|\Psr\Http\Message\ResponseInterface|null
     *
     * @throws Exception\AppointmentsGetListBadRequestException
     */
    public function appointmentsGetList(int $tenant, array $queryParameters = [], string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new Endpoint\AppointmentsGetList($tenant, $queryParameters), $fetch);
    }
     ...
     * @return Model\CrmV2AppointmentResponse|\Psr\Http\Message\ResponseInterface|null
     *
     * @throws Exception\AppointmentsAddBadRequestException
     * @throws Exception\AppointmentsAddConflictException
     */
    ...
    {
        return $this->executeEndpoint(new Endpoint\AppointmentsAdd($tenant, $requestBody), $fetch);
    }
     ...
     * @return Model\CrmV2AppointmentResponse|\Psr\Http\Message\ResponseInterface|null
     *
     * @throws Exception\AppointmentsRescheduleBadRequestException
     * @throws Exception\AppointmentsRescheduleNotFoundException
     * @throws Exception\AppointmentsRescheduleConflictException
     */
    ...
    {
        return $this->executeEndpoint(new Endpoint\AppointmentsReschedule($id, $tenant, $requestBody), $fetch);
    }
     ...
     * @return \Psr\Http\Message\ResponseInterface|null
     *
     * @throws Exception\AppointmentsRemoveHoldBadRequestException
     * @throws Exception\AppointmentsRemoveHoldNotFoundException
     * @throws Exception\AppointmentsRemoveHoldConflictException
     */
    public function appointmentsRemoveHold(int $id, int $tenant, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new Endpoint\AppointmentsRemoveHold($id, $tenant), $fetch);
    }
     ...
     * @return \Psr\Http\Message\ResponseInterface|null
     *
     * @throws Exception\AppointmentsHoldBadRequestException
     * @throws Exception\AppointmentsHoldNotFoundException
     * @throws Exception\AppointmentsHoldConflictException
     */
    ...
    {
        return $this->executeEndpoint(new Endpoint\AppointmentsHold($id, $tenant, $requestBody), $fetch);
    }
     ...
     * @return Model\CrmV2AppointmentResponse|\Psr\Http\Message\ResponseInterface|null
     *
     * @throws Exception\AppointmentsUpdateSpecialInstructionsBadRequestException
     * @throws Exception\AppointmentsUpdateSpecialInstructionsNotFoundException
     * @throws Exception\AppointmentsUpdateSpecialInstructionsConflictException
     */
    ...
    {
        return $this->executeEndpoint(new Endpoint\AppointmentsUpdateSpecialInstructions($id, $tenant, $requestBody), $fetch);
    }
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return Model\PaginatedResponseOfCrmV2JobCancelReasonResponse|\Psr\Http\Message\ResponseInterface|null
     *
     * @throws Exception\JobCancelReasonsGetListBadRequestException
     */
    public function jobCancelReasonsGetList(int $tenant, array $queryParameters = [], string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new Endpoint\JobCancelReasonsGetList($tenant, $queryParameters), $fetch);
    }
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return Model\PaginatedResponseOfCrmV2JobHoldReasonResponse|\Psr\Http\Message\ResponseInterface|null
     *
     * @throws Exception\JobHoldReasonsGetBadRequestException
     */
    public function jobHoldReasonsGet(int $tenant, array $queryParameters = [], string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new Endpoint\JobHoldReasonsGet($tenant, $queryParameters), $fetch);
    }
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return Model\CrmV2JobResponse|\Psr\Http\Message\ResponseInterface|null
     *
     * @throws Exception\JobsGetBadRequestException
     * @throws Exception\JobsGetNotFoundException
     */
    public function jobsGet(int $id, int $tenant, array $queryParameters = [], string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new Endpoint\JobsGet($id, $tenant, $queryParameters), $fetch);
    }
     ...
     * @return Model\CrmV2JobResponse|\Psr\Http\Message\ResponseInterface|null
     *
     * @throws Exception\JobsUpdateBadRequestException
     * @throws Exception\JobsUpdateNotFoundException
     */
    public function jobsUpdate(int $id, int $tenant, ?Model\CrmV2UpdateJobRequest $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new Endpoint\JobsUpdate($id, $tenant, $requestBody), $fetch);
    }
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return Model\PaginatedResponseOfCrmV2JobResponse|\Psr\Http\Message\ResponseInterface|null
     *
     * @throws Exception\JobsGetListBadRequestException
     */
    public function jobsGetList(int $tenant, array $queryParameters = [], string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new Endpoint\JobsGetList($tenant, $queryParameters), $fetch);
    }
     ...
     * @return Model\CrmV2JobResponse|\Psr\Http\Message\ResponseInterface|null
     *
     * @throws Exception\JobsCreateBadRequestException
     */
    public function jobsCreate(int $tenant, ?Model\CrmV2JobCreateRequest $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new Endpoint\JobsCreate($tenant, $requestBody), $fetch);
    }
     ...
     * @return \Psr\Http\Message\ResponseInterface|null
     *
     * @throws Exception\JobsCancelBadRequestException
     * @throws Exception\JobsCancelNotFoundException
     */
    public function jobsCancel(int $id, int $tenant, ?Model\CrmV2CancelJobRequest $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new Endpoint\JobsCancel($id, $tenant, $requestBody), $fetch);
    }
     ...
     * @return \Psr\Http\Message\ResponseInterface|null
     *
     * @throws Exception\JobsRemoveCancellationBadRequestException
     */
    public function jobsRemoveCancellation(int $id, int $tenant, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new Endpoint\JobsRemoveCancellation($id, $tenant), $fetch);
    }
     ...
     * @return \Psr\Http\Message\ResponseInterface|null
     *
     * @throws Exception\JobsHoldBadRequestException
     * @throws Exception\JobsHoldNotFoundException
     */
    public function jobsHold(int $id, int $tenant, ?Model\CrmV2HoldJobRequest $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new Endpoint\JobsHold($id, $tenant, $requestBody), $fetch);
    }
     ...
     * @return \Psr\Http\Message\ResponseInterface|null
     *
     * @throws Exception\JobsCompleteBadRequestException
     * @throws Exception\JobsCompleteNotFoundException
     * @throws Exception\JobsCompleteConflictException
     */
    ...
    {
        return $this->executeEndpoint(new Endpoint\JobsComplete($id, $tenant, $requestBody), $fetch);
    }
     ...
     *
     * @throws Exception\JobsGetNotesBadRequestException
     * @throws Exception\JobsGetNotesNotFoundException
     */
    public function jobsGetNotes(int $id, int $tenant, array $queryParameters = [], string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new Endpoint\JobsGetNotes($id, $tenant, $queryParameters), $fetch);
    }
     ...
     *
     * @throws Exception\JobsCreateNoteBadRequestException
     * @throws Exception\JobsCreateNoteNotFoundException
     */
    ...
    {
        return $this->executeEndpoint(new Endpoint\JobsCreateNote($id, $tenant, $requestBody), $fetch);
    }
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return Model\PaginatedResponseOfCrmV2CancelReasonResponse|\Psr\Http\Message\ResponseInterface|null
     *
     * @throws Exception\JobsGetCancelReasonsBadRequestException
     */
    public function jobsGetCancelReasons(int $tenant, array $queryParameters = [], string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new Endpoint\JobsGetCancelReasons($tenant, $queryParameters), $fetch);
    }
     ...
     * @param string $fetch  Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return Model\CrmV2JobHistoryResponse|\Psr\Http\Message\ResponseInterface|null
     *
     * @throws Exception\JobsGetHistoryBadRequestException
     * @throws Exception\JobsGetHistoryNotFoundException
     */
    public function jobsGetHistory(int $id, int $tenant, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new Endpoint\JobsGetHistory($id, $tenant), $fetch);
    }
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return Model\PaginatedResponseOfCrmV2JobTypeResponse|\Psr\Http\Message\ResponseInterface|null
     *
     * @throws Exception\JobTypesGetListBadRequestException
     */
    public function jobTypesGetList(int $tenant, array $queryParameters = [], string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new Endpoint\JobTypesGetList($tenant, $queryParameters), $fetch);
    }
     ...
     * @param string $fetch  Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return Model\CrmV2JobTypeResponse|\Psr\Http\Message\ResponseInterface|null
     *
     * @throws Exception\JobTypesCreateBadRequestException
     */
    ...
    {
        return $this->executeEndpoint(new Endpoint\JobTypesCreate($tenant, $requestBody), $fetch);
    }
     ...
     * @return Model\CrmV2JobTypeResponse|\Psr\Http\Message\ResponseInterface|null
     *
     * @throws Exception\JobTypesGetBadRequestException
     * @throws Exception\JobTypesGetNotFoundException
     */
    public function jobTypesGet(int $id, int $tenant, array $queryParameters = [], string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new Endpoint\JobTypesGet($id, $tenant, $queryParameters), $fetch);
    }
     ...
     * @return Model\CrmV2JobTypeResponse|\Psr\Http\Message\ResponseInterface|null
     *
     * @throws Exception\JobTypesUpdateBadRequestException
     */
    ...
    {
        return $this->executeEndpoint(new Endpoint\JobTypesUpdate($id, $tenant, $requestBody), $fetch);
    }
     ...
     * @param string $fetch  Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return Model\CrmV2ProjectResponse|\Psr\Http\Message\ResponseInterface|null
     *
     * @throws Exception\ProjectsGetBadRequestException
     * @throws Exception\ProjectsGetNotFoundException
     */
    public function projectsGet(int $id, int $tenant, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new Endpoint\ProjectsGet($id, $tenant), $fetch);
    }
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return Model\PaginatedResponseOfCrmV2ProjectResponse|\Psr\Http\Message\ResponseInterface|null
     *
     * @throws Exception\ProjectsGetListBadRequestException
     */
    public function projectsGetList(int $tenant, array $queryParameters = [], string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new Endpoint\ProjectsGetList($tenant, $queryParameters), $fetch);
    }
