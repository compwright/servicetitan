...
class PaginatedResponseOfAccountingV2PaymentTypeResponse
{
    /**
     * @var array
     */
     ...
     *
     * @var list<AccountingV2PaymentTypeResponse>
     */
    protected $data;
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @return list<AccountingV2PaymentTypeResponse>
     */
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @param list<AccountingV2PaymentTypeResponse> $data
     */
