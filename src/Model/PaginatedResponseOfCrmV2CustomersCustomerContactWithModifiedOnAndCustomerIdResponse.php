...
class PaginatedResponseOfCrmV2CustomersCustomerContactWithModifiedOnAndCustomerIdResponse
{
     ...
     *
     * @var CrmV2CustomersCustomerContactWithModifiedOnAndCustomerIdResponse[]
     */
    protected $data;
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @return CrmV2CustomersCustomerContactWithModifiedOnAndCustomerIdResponse[]
     */
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @param CrmV2CustomersCustomerContactWithModifiedOnAndCustomerIdResponse[] $data
     */
