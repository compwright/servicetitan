...
class PaginatedResponseOfCrmV2CustomersCustomerContactWithModifiedOnAndCustomerIdResponse
{
    /**
     * @var array
     */
     ...
     *
     * @var list<CrmV2CustomersCustomerContactWithModifiedOnAndCustomerIdResponse>
     */
    protected $data;
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @return list<CrmV2CustomersCustomerContactWithModifiedOnAndCustomerIdResponse>
     */
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @param list<CrmV2CustomersCustomerContactWithModifiedOnAndCustomerIdResponse> $data
     */
