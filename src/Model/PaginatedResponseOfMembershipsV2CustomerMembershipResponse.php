...
class PaginatedResponseOfMembershipsV2CustomerMembershipResponse
{
    /**
     * @var array
     */
     ...
     *
     * @var list<MembershipsV2CustomerMembershipResponse>
     */
    protected $data;
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @return list<MembershipsV2CustomerMembershipResponse>
     */
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @param list<MembershipsV2CustomerMembershipResponse> $data
     */
