...
class PaginatedResponseOfPayrollV2GrossPayItemsGrossPayItemResponse
{
    /**
     * @var array
     */
     ...
     *
     * @var list<PayrollV2GrossPayItemsGrossPayItemResponse>
     */
    protected $data;
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @return list<PayrollV2GrossPayItemsGrossPayItemResponse>
     */
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @param list<PayrollV2GrossPayItemsGrossPayItemResponse> $data
     */
