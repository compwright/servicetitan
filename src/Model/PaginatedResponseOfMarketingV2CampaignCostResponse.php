...
class PaginatedResponseOfMarketingV2CampaignCostResponse
{
    /**
     * @var array
     */
     ...
     *
     * @var list<MarketingV2CampaignCostResponse>
     */
    protected $data;
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @return list<MarketingV2CampaignCostResponse>
     */
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @param list<MarketingV2CampaignCostResponse> $data
     */
