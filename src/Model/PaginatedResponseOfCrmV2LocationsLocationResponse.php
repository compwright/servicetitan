...
class PaginatedResponseOfCrmV2LocationsLocationResponse
{
    /**
     * @var array
     */
     ...
     *
     * @var list<CrmV2LocationsLocationResponse>
     */
    protected $data;
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @return list<CrmV2LocationsLocationResponse>
     */
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @param list<CrmV2LocationsLocationResponse> $data
     */
