...
class PaginatedResponseOfPricebookV2MaterialResponse
{
    /**
     * @var array
     */
     ...
     *
     * @var list<PricebookV2MaterialResponse>
     */
    protected $data;
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @return list<PricebookV2MaterialResponse>
     */
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @param list<PricebookV2MaterialResponse> $data
     */
