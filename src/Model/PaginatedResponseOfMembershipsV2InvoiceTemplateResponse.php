...
class PaginatedResponseOfMembershipsV2InvoiceTemplateResponse
{
    /**
     * @var array
     */
     ...
     *
     * @var list<MembershipsV2InvoiceTemplateResponse>
     */
    protected $data;
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @return list<MembershipsV2InvoiceTemplateResponse>
     */
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @param list<MembershipsV2InvoiceTemplateResponse> $data
     */
