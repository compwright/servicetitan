...
class PaginatedResponseOfDispatchV2ZoneResponse
{
    /**
     * @var array
     */
     ...
     *
     * @var list<DispatchV2ZoneResponse>
     */
    protected $data;
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @return list<DispatchV2ZoneResponse>
     */
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @param list<DispatchV2ZoneResponse> $data
     */
