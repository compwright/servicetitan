...
class PaginatedResponseOfPricebookV2DiscountAndFeesResponse
{
    /**
     * @var array
     */
     ...
     *
     * @var list<PricebookV2DiscountAndFeesResponse>
     */
    protected $data;
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @return list<PricebookV2DiscountAndFeesResponse>
     */
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @param list<PricebookV2DiscountAndFeesResponse> $data
     */
