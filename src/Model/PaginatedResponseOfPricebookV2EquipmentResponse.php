...
class PaginatedResponseOfPricebookV2EquipmentResponse
{
    /**
     * @var array
     */
     ...
     *
     * @var list<PricebookV2EquipmentResponse>
     */
    protected $data;
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @return list<PricebookV2EquipmentResponse>
     */
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @param list<PricebookV2EquipmentResponse> $data
     */
