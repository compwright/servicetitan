...
class PaginatedResponseOfMembershipsV2RecurringServiceTypeResponse
{
    /**
     * @var array
     */
     ...
     *
     * @var list<MembershipsV2RecurringServiceTypeResponse>
     */
    protected $data;
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @return list<MembershipsV2RecurringServiceTypeResponse>
     */
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @param list<MembershipsV2RecurringServiceTypeResponse> $data
     */
