...
class PaginatedResponseOfTenantSettingsV2BusinessUnitResponse
{
    /**
     * @var array
     */
     ...
     *
     * @var list<TenantSettingsV2BusinessUnitResponse>
     */
    protected $data;
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @return list<TenantSettingsV2BusinessUnitResponse>
     */
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @param list<TenantSettingsV2BusinessUnitResponse> $data
     */
