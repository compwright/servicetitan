...
class PaginatedResponseOfMembershipsV2LocationRecurringServiceResponse
{
    /**
     * @var array
     */
     ...
     *
     * @var list<MembershipsV2LocationRecurringServiceResponse>
     */
    protected $data;
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @return list<MembershipsV2LocationRecurringServiceResponse>
     */
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @param list<MembershipsV2LocationRecurringServiceResponse> $data
     */
