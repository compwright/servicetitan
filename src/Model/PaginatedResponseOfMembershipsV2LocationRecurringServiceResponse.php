...
class PaginatedResponseOfMembershipsV2LocationRecurringServiceResponse
{
     ...
     *
     * @var MembershipsV2LocationRecurringServiceResponse[]
     */
    protected $data;
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @return MembershipsV2LocationRecurringServiceResponse[]
     */
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @param MembershipsV2LocationRecurringServiceResponse[] $data
     */
