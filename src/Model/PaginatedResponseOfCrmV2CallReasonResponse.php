...
class PaginatedResponseOfCrmV2CallReasonResponse
{
    /**
     * @var array
     */
     ...
     *
     * @var list<CrmV2CallReasonResponse>
     */
    protected $data;
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @return list<CrmV2CallReasonResponse>
     */
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @param list<CrmV2CallReasonResponse> $data
     */
