...
class PaginatedResponseOfCrmV2JobCancelReasonResponse
{
    /**
     * @var array
     */
     ...
     *
     * @var list<CrmV2JobCancelReasonResponse>
     */
    protected $data;
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @return list<CrmV2JobCancelReasonResponse>
     */
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @param list<CrmV2JobCancelReasonResponse> $data
     */
