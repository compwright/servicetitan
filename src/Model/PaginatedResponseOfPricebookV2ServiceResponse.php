...
class PaginatedResponseOfPricebookV2ServiceResponse
{
    /**
     * @var array
     */
     ...
     *
     * @var list<PricebookV2ServiceResponse>
     */
    protected $data;
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @return list<PricebookV2ServiceResponse>
     */
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @param list<PricebookV2ServiceResponse> $data
     */
