...
class ModuleTelecomSharedBundleCallModel
{
    /**
     * @var array
     */
    ...
    protected $type;
    /**
     * @var ModuleTelecomSharedCallModel
     */
    protected $leadCall;
    ...
    public function getLeadCall(): ModuleTelecomSharedCallModel
    {
        return $this->leadCall;
    }

    public function setLeadCall(ModuleTelecomSharedCallModel $leadCall): self
    {
