...
class PaginatedResponseOfCrmV2AppointmentAssignmentResponse
{
    /**
     * @var array
     */
     ...
     *
     * @var list<CrmV2AppointmentAssignmentResponse>
     */
    protected $data;
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @return list<CrmV2AppointmentAssignmentResponse>
     */
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @param list<CrmV2AppointmentAssignmentResponse> $data
     */
