...
class PaginatedResponseOfMembershipsV2LocationRecurringServiceEventResponse
{
     ...
     *
     * @var MembershipsV2LocationRecurringServiceEventResponse[]
     */
    protected $data;
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @return MembershipsV2LocationRecurringServiceEventResponse[]
     */
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @param MembershipsV2LocationRecurringServiceEventResponse[] $data
     */
