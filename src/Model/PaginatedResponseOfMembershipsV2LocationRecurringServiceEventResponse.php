...
class PaginatedResponseOfMembershipsV2LocationRecurringServiceEventResponse
{
    /**
     * @var array
     */
     ...
     *
     * @var list<MembershipsV2LocationRecurringServiceEventResponse>
     */
    protected $data;
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @return list<MembershipsV2LocationRecurringServiceEventResponse>
     */
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @param list<MembershipsV2LocationRecurringServiceEventResponse> $data
     */
