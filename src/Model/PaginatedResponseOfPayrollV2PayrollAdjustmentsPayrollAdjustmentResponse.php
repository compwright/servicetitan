...
class PaginatedResponseOfPayrollV2PayrollAdjustmentsPayrollAdjustmentResponse
{
     ...
     *
     * @var PayrollV2PayrollAdjustmentsPayrollAdjustmentResponse[]
     */
    protected $data;
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @return PayrollV2PayrollAdjustmentsPayrollAdjustmentResponse[]
     */
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @param PayrollV2PayrollAdjustmentsPayrollAdjustmentResponse[] $data
     */
