...
class PaginatedResponseOfPayrollV2PayrollAdjustmentsPayrollAdjustmentResponse
{
    /**
     * @var array
     */
     ...
     *
     * @var list<PayrollV2PayrollAdjustmentsPayrollAdjustmentResponse>
     */
    protected $data;
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @return list<PayrollV2PayrollAdjustmentsPayrollAdjustmentResponse>
     */
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @param list<PayrollV2PayrollAdjustmentsPayrollAdjustmentResponse> $data
     */
