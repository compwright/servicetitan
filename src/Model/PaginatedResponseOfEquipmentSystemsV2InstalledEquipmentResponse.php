...
class PaginatedResponseOfEquipmentSystemsV2InstalledEquipmentResponse
{
    /**
     * @var array
     */
     ...
     *
     * @var list<EquipmentSystemsV2InstalledEquipmentResponse>
     */
    protected $data;
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @return list<EquipmentSystemsV2InstalledEquipmentResponse>
     */
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @param list<EquipmentSystemsV2InstalledEquipmentResponse> $data
     */
