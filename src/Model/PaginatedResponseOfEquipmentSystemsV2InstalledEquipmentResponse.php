...
class PaginatedResponseOfEquipmentSystemsV2InstalledEquipmentResponse
{
     ...
     *
     * @var EquipmentSystemsV2InstalledEquipmentResponse[]
     */
    protected $data;
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @return EquipmentSystemsV2InstalledEquipmentResponse[]
     */
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @param EquipmentSystemsV2InstalledEquipmentResponse[] $data
     */
