...
class PaginatedResponseOfPayrollV2TimesheetCodesTimesheetCodeResponse
{
    /**
     * @var array
     */
     ...
     *
     * @var list<PayrollV2TimesheetCodesTimesheetCodeResponse>
     */
    protected $data;
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @return list<PayrollV2TimesheetCodesTimesheetCodeResponse>
     */
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @param list<PayrollV2TimesheetCodesTimesheetCodeResponse> $data
     */
