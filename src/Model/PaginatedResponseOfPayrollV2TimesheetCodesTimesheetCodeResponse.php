...
class PaginatedResponseOfPayrollV2TimesheetCodesTimesheetCodeResponse
{
     ...
     *
     * @var PayrollV2TimesheetCodesTimesheetCodeResponse[]
     */
    protected $data;
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @return PayrollV2TimesheetCodesTimesheetCodeResponse[]
     */
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @param PayrollV2TimesheetCodesTimesheetCodeResponse[] $data
     */
