...
class PaginatedResponseOfTenantSettingsV2TagTypeResponse
{
    /**
     * @var array
     */
     ...
     *
     * @var list<TenantSettingsV2TagTypeResponse>
     */
    protected $data;
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @return list<TenantSettingsV2TagTypeResponse>
     */
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @param list<TenantSettingsV2TagTypeResponse> $data
     */
