...
class PaginatedResponseOfCrmV2LocationsContactResponse
{
    /**
     * @var array
     */
     ...
     *
     * @var list<CrmV2LocationsContactResponse>
     */
    protected $data;
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @return list<CrmV2LocationsContactResponse>
     */
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @param list<CrmV2LocationsContactResponse> $data
     */
