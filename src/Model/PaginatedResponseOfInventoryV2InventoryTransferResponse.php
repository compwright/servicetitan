...
class PaginatedResponseOfInventoryV2InventoryTransferResponse
{
    /**
     * @var array
     */
     ...
     *
     * @var list<InventoryV2InventoryTransferResponse>
     */
    protected $data;
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @return list<InventoryV2InventoryTransferResponse>
     */
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @param list<InventoryV2InventoryTransferResponse> $data
     */
