...
class PaginatedResponseOfDispatchV2TechnicianShiftResponse
{
    /**
     * @var array
     */
     ...
     *
     * @var list<DispatchV2TechnicianShiftResponse>
     */
    protected $data;
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @return list<DispatchV2TechnicianShiftResponse>
     */
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @param list<DispatchV2TechnicianShiftResponse> $data
     */
