...
class PaginatedResponseOfMarketingV2CampaignResponse
{
    /**
     * @var array
     */
     ...
     *
     * @var list<MarketingV2CampaignResponse>
     */
    protected $data;
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @return list<MarketingV2CampaignResponse>
     */
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @param list<MarketingV2CampaignResponse> $data
     */
