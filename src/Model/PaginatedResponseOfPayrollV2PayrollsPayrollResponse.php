...
class PaginatedResponseOfPayrollV2PayrollsPayrollResponse
{
    /**
     * @var array
     */
     ...
     *
     * @var list<PayrollV2PayrollsPayrollResponse>
     */
    protected $data;
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @return list<PayrollV2PayrollsPayrollResponse>
     */
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @param list<PayrollV2PayrollsPayrollResponse> $data
     */
