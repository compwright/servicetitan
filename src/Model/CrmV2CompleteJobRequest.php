...
/**
 * CrmV2CompleteJobRequest Class Doc Comment
 *
 * @category Class
 * @package  CompWright\ServiceTitan
 * @author   OpenAPI Generator team
 ...
 */
class CrmV2CompleteJobRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Crm.V2.CompleteJobRequest';
     ...
     * Sets completed_on
     *
     * @param \DateTime $completed_on Date on which the job was completed
     *
     * @return self
     */
