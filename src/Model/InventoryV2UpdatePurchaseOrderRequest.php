...
class InventoryV2UpdatePurchaseOrderRequest
{
     ...
     *
     * @var list<InventoryV2UpdatePurchaseOrderItemRequest>
     */
    protected $items;
     ...
     * List of new/updated PO items. Every active PO item that is not on this list will be marked as inactive.
     *
     * @return list<InventoryV2UpdatePurchaseOrderItemRequest>
     */
     ...
     * List of new/updated PO items. Every active PO item that is not on this list will be marked as inactive.
     *
     * @param list<InventoryV2UpdatePurchaseOrderItemRequest> $items
     */
