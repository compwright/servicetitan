...
class PaginatedResponseOfInventoryV2InventoryAdjustmentResponse
{
    /**
     * @var array
     */
     ...
     *
     * @var list<InventoryV2InventoryAdjustmentResponse>
     */
    protected $data;
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @return list<InventoryV2InventoryAdjustmentResponse>
     */
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @param list<InventoryV2InventoryAdjustmentResponse> $data
     */
