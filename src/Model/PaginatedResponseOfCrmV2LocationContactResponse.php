...
class PaginatedResponseOfCrmV2LocationContactResponse
{
    /**
     * @var array
     */
     ...
     *
     * @var list<CrmV2LocationContactResponse>
     */
    protected $data;
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @return list<CrmV2LocationContactResponse>
     */
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @param list<CrmV2LocationContactResponse> $data
     */
