...
class PaginatedResponseOfInventoryV2PurchaseOrderTypeResponse
{
    /**
     * @var array
     */
     ...
     *
     * @var list<InventoryV2PurchaseOrderTypeResponse>
     */
    protected $data;
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @return list<InventoryV2PurchaseOrderTypeResponse>
     */
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @param list<InventoryV2PurchaseOrderTypeResponse> $data
     */
