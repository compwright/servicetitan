...
class PaginatedResponseOfInventoryV2PurchaseOrderResponse
{
    /**
     * @var array
     */
     ...
     *
     * @var list<InventoryV2PurchaseOrderResponse>
     */
    protected $data;
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @return list<InventoryV2PurchaseOrderResponse>
     */
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @param list<InventoryV2PurchaseOrderResponse> $data
     */
