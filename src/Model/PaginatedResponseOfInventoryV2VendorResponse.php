...
class PaginatedResponseOfInventoryV2VendorResponse
{
    /**
     * @var array
     */
     ...
     *
     * @var list<InventoryV2VendorResponse>
     */
    protected $data;
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @return list<InventoryV2VendorResponse>
     */
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @param list<InventoryV2VendorResponse> $data
     */
