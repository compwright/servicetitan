...
class PaginatedResponseOfTenantSettingsV2EmployeeResponse
{
    /**
     * @var array
     */
     ...
     *
     * @var list<TenantSettingsV2EmployeeResponse>
     */
    protected $data;
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @return list<TenantSettingsV2EmployeeResponse>
     */
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @param list<TenantSettingsV2EmployeeResponse> $data
     */
