...
class PaginatedResponseOfAccountingV2TaxZoneResponse
{
    /**
     * @var array
     */
     ...
     *
     * @var list<AccountingV2TaxZoneResponse>
     */
    protected $data;
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @return list<AccountingV2TaxZoneResponse>
     */
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @param list<AccountingV2TaxZoneResponse> $data
     */
