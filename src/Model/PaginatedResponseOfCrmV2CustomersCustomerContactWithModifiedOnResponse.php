...
class PaginatedResponseOfCrmV2CustomersCustomerContactWithModifiedOnResponse
{
    /**
     * @var array
     */
     ...
     *
     * @var list<CrmV2CustomersCustomerContactWithModifiedOnResponse>
     */
    protected $data;
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @return list<CrmV2CustomersCustomerContactWithModifiedOnResponse>
     */
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @param list<CrmV2CustomersCustomerContactWithModifiedOnResponse> $data
     */
