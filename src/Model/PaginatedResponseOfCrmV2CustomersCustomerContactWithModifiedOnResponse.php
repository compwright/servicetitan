...
class PaginatedResponseOfCrmV2CustomersCustomerContactWithModifiedOnResponse
{
     ...
     *
     * @var CrmV2CustomersCustomerContactWithModifiedOnResponse[]
     */
    protected $data;
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @return CrmV2CustomersCustomerContactWithModifiedOnResponse[]
     */
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @param CrmV2CustomersCustomerContactWithModifiedOnResponse[] $data
     */
