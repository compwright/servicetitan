...
class PaginatedResponseOfEstimatesV2EstimateResponse
{
    /**
     * @var array
     */
     ...
     *
     * @var list<EstimatesV2EstimateResponse>
     */
    protected $data;
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @return list<EstimatesV2EstimateResponse>
     */
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @param list<EstimatesV2EstimateResponse> $data
     */
