...
class PaginatedResponseOfAccountingV2DetailedPaymentResponse
{
    /**
     * @var array
     */
     ...
     *
     * @var list<AccountingV2DetailedPaymentResponse>
     */
    protected $data;
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @return list<AccountingV2DetailedPaymentResponse>
     */
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @param list<AccountingV2DetailedPaymentResponse> $data
     */
