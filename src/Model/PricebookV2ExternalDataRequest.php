...
class PricebookV2ExternalDataRequest
{
     ...
     * If entity A has custom data with keys X and Y and this field only contains an item
     * with a key X, then custom data with a key Y on job A will be removed.
     *
     * @var list<PricebookV2ExternalDataModel>
     */
     ...
     * with a key X, then custom data with a key Y on job A will be removed.
     *
     * @return list<PricebookV2ExternalDataModel>
     */
     ...
     * with a key X, then custom data with a key Y on job A will be removed.
     *
     * @param list<PricebookV2ExternalDataModel> $externalData
     */
