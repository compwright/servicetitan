...
class PaginatedResponseOfInventoryV2TruckResponse
{
    /**
     * @var array
     */
     ...
     *
     * @var list<InventoryV2TruckResponse>
     */
    protected $data;
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @return list<InventoryV2TruckResponse>
     */
     ...
     * The collection of result items, will never have more than PageSize items.
     *
     * @param list<InventoryV2TruckResponse> $data
     */
