# # PaginatedResponseOfCrmV2CancelReasonResponse
...
**data** | [**\CompWright\ServiceTitan\Model\CrmV2CancelReasonResponse[]**](CrmV2CancelReasonResponse.md) | The collection of result items, will never have more than PageSize items |
