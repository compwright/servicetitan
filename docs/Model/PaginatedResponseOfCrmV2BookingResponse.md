# # PaginatedResponseOfCrmV2BookingResponse
...
**data** | [**\CompWright\ServiceTitan\Model\CrmV2BookingResponse[]**](CrmV2BookingResponse.md) | The collection of result items, will never have more than PageSize items |
