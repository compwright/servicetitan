# # PaginatedResponseOfEstimatesV2EstimateResponse
...
**data** | [**\CompWright\ServiceTitan\Model\EstimatesV2EstimateResponse[]**](EstimatesV2EstimateResponse.md) | The collection of result items, will never have more than PageSize items |
