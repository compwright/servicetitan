# # PaginatedResponseOfMarketingV2CampaignCostResponse
...
**data** | [**\CompWright\ServiceTitan\Model\MarketingV2CampaignCostResponse[]**](MarketingV2CampaignCostResponse.md) | The collection of result items, will never have more than PageSize items |
