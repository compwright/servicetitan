# # PaginatedResponseOfMembershipsV2CustomerMembershipResponse
...
**data** | [**\CompWright\ServiceTitan\Model\MembershipsV2CustomerMembershipResponse[]**](MembershipsV2CustomerMembershipResponse.md) | The collection of result items, will never have more than PageSize items |
