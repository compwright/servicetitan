# # PaginatedResponseOfTenantSettingsV2BusinessUnitResponse
...
**data** | [**\CompWright\ServiceTitan\Model\TenantSettingsV2BusinessUnitResponse[]**](TenantSettingsV2BusinessUnitResponse.md) | The collection of result items, will never have more than PageSize items |
