# # PaginatedResponseOfCrmV2JobHoldReasonResponse
...
**data** | [**\CompWright\ServiceTitan\Model\CrmV2JobHoldReasonResponse[]**](CrmV2JobHoldReasonResponse.md) | The collection of result items, will never have more than PageSize items |
