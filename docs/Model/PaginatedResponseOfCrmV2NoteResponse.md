# # PaginatedResponseOfCrmV2NoteResponse
...
**data** | [**\CompWright\ServiceTitan\Model\CrmV2NoteResponse[]**](CrmV2NoteResponse.md) | The collection of result items, will never have more than PageSize items |
