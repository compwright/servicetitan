# # PaginatedResponseOfCrmV2AppointmentAssignmentResponse
...
**data** | [**\CompWright\ServiceTitan\Model\CrmV2AppointmentAssignmentResponse[]**](CrmV2AppointmentAssignmentResponse.md) | The collection of result items, will never have more than PageSize items |
