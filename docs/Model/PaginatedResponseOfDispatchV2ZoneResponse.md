# # PaginatedResponseOfDispatchV2ZoneResponse
...
**data** | [**\CompWright\ServiceTitan\Model\DispatchV2ZoneResponse[]**](DispatchV2ZoneResponse.md) | The collection of result items, will never have more than PageSize items |
