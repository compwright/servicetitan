# # PaginatedResponseOfDispatchV2NonJobAppointmentResponse
...
**data** | [**\CompWright\ServiceTitan\Model\DispatchV2NonJobAppointmentResponse[]**](DispatchV2NonJobAppointmentResponse.md) | The collection of result items, will never have more than PageSize items |
