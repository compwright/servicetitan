# # PaginatedResponseOfCrmV2JobResponse
...
**data** | [**\CompWright\ServiceTitan\Model\CrmV2JobResponse[]**](CrmV2JobResponse.md) | The collection of result items, will never have more than PageSize items |
