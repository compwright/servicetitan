# # PaginatedResponseOfMembershipsV2RecurringServiceTypeResponse
...
**data** | [**\CompWright\ServiceTitan\Model\MembershipsV2RecurringServiceTypeResponse[]**](MembershipsV2RecurringServiceTypeResponse.md) | The collection of result items, will never have more than PageSize items |
