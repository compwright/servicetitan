# # PaginatedResponseOfCrmV2LocationsLocationResponse
...
**data** | [**\CompWright\ServiceTitan\Model\CrmV2LocationsLocationResponse[]**](CrmV2LocationsLocationResponse.md) | The collection of result items, will never have more than PageSize items |
