# # PaginatedResponseOfMarketingV2CampaignCategoryResponse
...
**data** | [**\CompWright\ServiceTitan\Model\MarketingV2CampaignCategoryResponse[]**](MarketingV2CampaignCategoryResponse.md) | The collection of result items, will never have more than PageSize items |
