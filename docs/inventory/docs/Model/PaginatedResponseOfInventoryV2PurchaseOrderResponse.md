# # PaginatedResponseOfInventoryV2PurchaseOrderResponse
...
**data** | [**\CompWright\ServiceTitan\Model\InventoryV2PurchaseOrderResponse[]**](InventoryV2PurchaseOrderResponse.md) | The collection of result items, will never have more than PageSize items |
