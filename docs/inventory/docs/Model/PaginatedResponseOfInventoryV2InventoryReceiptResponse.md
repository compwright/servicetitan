# # PaginatedResponseOfInventoryV2InventoryReceiptResponse
...
**data** | [**\CompWright\ServiceTitan\Model\InventoryV2InventoryReceiptResponse[]**](InventoryV2InventoryReceiptResponse.md) | The collection of result items, will never have more than PageSize items |
