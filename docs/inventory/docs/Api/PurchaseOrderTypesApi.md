...
------------- | ------------- | -------------
[**purchaseOrderTypesGetList()**](PurchaseOrderTypesApi.md#purchaseOrderTypesGetList) | **GET** /tenant/{tenant}/purchase-order-types | Get a list of purchase order types
