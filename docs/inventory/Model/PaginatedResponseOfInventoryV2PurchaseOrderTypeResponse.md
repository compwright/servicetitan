# # PaginatedResponseOfInventoryV2PurchaseOrderTypeResponse
...
**data** | [**\CompWright\ServiceTitan\Model\InventoryV2PurchaseOrderTypeResponse[]**](InventoryV2PurchaseOrderTypeResponse.md) | The collection of result items, will never have more than PageSize items |
