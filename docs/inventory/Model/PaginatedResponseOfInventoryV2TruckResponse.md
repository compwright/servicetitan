# # PaginatedResponseOfInventoryV2TruckResponse
...
**data** | [**\CompWright\ServiceTitan\Model\InventoryV2TruckResponse[]**](InventoryV2TruckResponse.md) | The collection of result items, will never have more than PageSize items |
