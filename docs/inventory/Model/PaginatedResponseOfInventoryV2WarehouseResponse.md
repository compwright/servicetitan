# # PaginatedResponseOfInventoryV2WarehouseResponse
...
**data** | [**\CompWright\ServiceTitan\Model\InventoryV2WarehouseResponse[]**](InventoryV2WarehouseResponse.md) | The collection of result items, will never have more than PageSize items |
