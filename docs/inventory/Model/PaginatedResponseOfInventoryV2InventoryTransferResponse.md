# # PaginatedResponseOfInventoryV2InventoryTransferResponse
...
**data** | [**\CompWright\ServiceTitan\Model\InventoryV2InventoryTransferResponse[]**](InventoryV2InventoryTransferResponse.md) | The collection of result items, will never have more than PageSize items |
