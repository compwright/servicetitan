# # PaginatedResponseOfInventoryV2InventoryReturnResponse
...
**data** | [**\CompWright\ServiceTitan\Model\InventoryV2InventoryReturnResponse[]**](InventoryV2InventoryReturnResponse.md) | The collection of result items, will never have more than PageSize items |
