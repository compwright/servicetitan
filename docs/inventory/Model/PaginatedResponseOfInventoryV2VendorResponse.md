# # PaginatedResponseOfInventoryV2VendorResponse
...
**data** | [**\CompWright\ServiceTitan\Model\InventoryV2VendorResponse[]**](InventoryV2VendorResponse.md) | The collection of result items, will never have more than PageSize items |
