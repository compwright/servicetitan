# # PaginatedResponseOfMarketingV2CampaignResponse
...
**data** | [**\CompWright\ServiceTitan\Model\MarketingV2CampaignResponse[]**](MarketingV2CampaignResponse.md) | The collection of result items, will never have more than PageSize items |
