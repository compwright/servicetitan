# # PaginatedResponseOfCrmV2JobTypeResponse
...
**data** | [**\CompWright\ServiceTitan\Model\CrmV2JobTypeResponse[]**](CrmV2JobTypeResponse.md) | The collection of result items, will never have more than PageSize items |
