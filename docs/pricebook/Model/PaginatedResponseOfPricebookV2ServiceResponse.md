# # PaginatedResponseOfPricebookV2ServiceResponse
...
**data** | [**\CompWright\ServiceTitan\Model\PricebookV2ServiceResponse[]**](PricebookV2ServiceResponse.md) | The collection of result items, will never have more than PageSize items |
