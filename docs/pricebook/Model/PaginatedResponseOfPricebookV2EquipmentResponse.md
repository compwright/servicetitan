# # PaginatedResponseOfPricebookV2EquipmentResponse
...
**data** | [**\CompWright\ServiceTitan\Model\PricebookV2EquipmentResponse[]**](PricebookV2EquipmentResponse.md) | The collection of result items, will never have more than PageSize items |
