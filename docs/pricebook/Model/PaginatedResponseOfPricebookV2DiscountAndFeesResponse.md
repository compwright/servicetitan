# # PaginatedResponseOfPricebookV2DiscountAndFeesResponse
...
**data** | [**\CompWright\ServiceTitan\Model\PricebookV2DiscountAndFeesResponse[]**](PricebookV2DiscountAndFeesResponse.md) | The collection of result items, will never have more than PageSize items |
