# # PaginatedResponseOfPricebookV2CategoryResponse
...
**data** | [**\CompWright\ServiceTitan\Model\PricebookV2CategoryResponse[]**](PricebookV2CategoryResponse.md) | The collection of result items, will never have more than PageSize items |
