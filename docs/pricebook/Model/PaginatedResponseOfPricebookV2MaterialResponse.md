# # PaginatedResponseOfPricebookV2MaterialResponse
...
**data** | [**\CompWright\ServiceTitan\Model\PricebookV2MaterialResponse[]**](PricebookV2MaterialResponse.md) | The collection of result items, will never have more than PageSize items |
