# # PaginatedResponseOfAccountingV2PaymentTypeResponse
...
**data** | [**\CompWright\ServiceTitan\Model\AccountingV2PaymentTypeResponse[]**](AccountingV2PaymentTypeResponse.md) | The collection of result items, will never have more than PageSize items |
