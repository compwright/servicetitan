# # PaginatedResponseOfAccountingV2TaxZoneResponse
...
**data** | [**\CompWright\ServiceTitan\Model\AccountingV2TaxZoneResponse[]**](AccountingV2TaxZoneResponse.md) | The collection of result items, will never have more than PageSize items |
