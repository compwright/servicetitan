# # PaginatedResponseOfAccountingV2DetailedPaymentResponse
...
**data** | [**\CompWright\ServiceTitan\Model\AccountingV2DetailedPaymentResponse[]**](AccountingV2DetailedPaymentResponse.md) | The collection of result items, will never have more than PageSize items |
