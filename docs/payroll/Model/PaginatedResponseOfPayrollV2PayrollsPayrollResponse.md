# # PaginatedResponseOfPayrollV2PayrollsPayrollResponse
...
**data** | [**\CompWright\ServiceTitan\Model\PayrollV2PayrollsPayrollResponse[]**](PayrollV2PayrollsPayrollResponse.md) | The collection of result items, will never have more than PageSize items |
