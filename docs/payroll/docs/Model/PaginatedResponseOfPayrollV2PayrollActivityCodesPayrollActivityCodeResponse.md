# # PaginatedResponseOfPayrollV2PayrollActivityCodesPayrollActivityCodeResponse
...
**data** | [**\CompWright\ServiceTitan\Model\PayrollV2PayrollActivityCodesPayrollActivityCodeResponse[]**](PayrollV2PayrollActivityCodesPayrollActivityCodeResponse.md) | The collection of result items, will never have more than PageSize items |
