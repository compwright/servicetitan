# # PaginatedResponseOfEstimatesV2EstimateItemResponse
...
**data** | [**\CompWright\ServiceTitan\Model\EstimatesV2EstimateItemResponse[]**](EstimatesV2EstimateItemResponse.md) | The collection of result items, will never have more than PageSize items |
