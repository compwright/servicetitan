# # PaginatedResponseOfCrmV2LocationsContactResponse
...
**data** | [**\CompWright\ServiceTitan\Model\CrmV2LocationsContactResponse[]**](CrmV2LocationsContactResponse.md) | The collection of result items, will never have more than PageSize items |
