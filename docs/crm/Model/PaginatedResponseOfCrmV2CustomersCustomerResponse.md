# # PaginatedResponseOfCrmV2CustomersCustomerResponse
...
**data** | [**\CompWright\ServiceTitan\Model\CrmV2CustomersCustomerResponse[]**](CrmV2CustomersCustomerResponse.md) | The collection of result items, will never have more than PageSize items |
