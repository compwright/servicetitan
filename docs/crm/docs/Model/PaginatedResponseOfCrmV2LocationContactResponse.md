# # PaginatedResponseOfCrmV2LocationContactResponse
...
**data** | [**\CompWright\ServiceTitan\Model\CrmV2LocationContactResponse[]**](CrmV2LocationContactResponse.md) | The collection of result items, will never have more than PageSize items |
