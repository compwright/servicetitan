# CompWright\ServiceTitan\ZoneApi

All URIs are relative to https://api-integration.servicetitan.io/dispatch/v2.

Method | HTTP request | Description
------------- | ------------- | -------------
[**zoneGet()**](ZoneApi.md#zoneGet) | **GET** /tenant/{tenant}/zones/{id} | Gets a specific zone
[**zoneGetList()**](ZoneApi.md#zoneGetList) | **GET** /tenant/{tenant}/zones | Gets a list of zones
