# # PaginatedResponseOfTenantSettingsV2TagTypeResponse
...
**data** | [**\CompWright\ServiceTitan\Model\TenantSettingsV2TagTypeResponse[]**](TenantSettingsV2TagTypeResponse.md) | The collection of result items, will never have more than PageSize items |
