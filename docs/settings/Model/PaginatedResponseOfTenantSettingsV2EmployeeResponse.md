# # PaginatedResponseOfTenantSettingsV2EmployeeResponse
...
**data** | [**\CompWright\ServiceTitan\Model\TenantSettingsV2EmployeeResponse[]**](TenantSettingsV2EmployeeResponse.md) | The collection of result items, will never have more than PageSize items |
