...
| ------------- | ------------- | ------------- |
| [**campaignsCreate()**](CampaignsApi.md#campaignsCreate) | **POST** /marketing/v2/tenant/{tenant}/campaigns | Creates new campaign |
| [**campaignsGet()**](CampaignsApi.md#campaignsGet) | **GET** /marketing/v2/tenant/{tenant}/campaigns/{id} | Gets campaign specified by ID |
| [**campaignsGetCosts()**](CampaignsApi.md#campaignsGetCosts) | **GET** /marketing/v2/tenant/{tenant}/campaigns/{id}/costs | Gets a paginated list of campaign costs |
| [**campaignsGetList()**](CampaignsApi.md#campaignsGetList) | **GET** /marketing/v2/tenant/{tenant}/campaigns | Gets a paginated list of campaigns |
| [**campaignsUpdate()**](CampaignsApi.md#campaignsUpdate) | **PATCH** /marketing/v2/tenant/{tenant}/campaigns/{id} | Updates specified campaign in \&quot;patch\&quot; mode |
