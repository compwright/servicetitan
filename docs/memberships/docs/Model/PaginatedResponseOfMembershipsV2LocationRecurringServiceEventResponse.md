# # PaginatedResponseOfMembershipsV2LocationRecurringServiceEventResponse
...
**data** | [**\CompWright\ServiceTitan\Model\MembershipsV2LocationRecurringServiceEventResponse[]**](MembershipsV2LocationRecurringServiceEventResponse.md) | The collection of result items, will never have more than PageSize items |
