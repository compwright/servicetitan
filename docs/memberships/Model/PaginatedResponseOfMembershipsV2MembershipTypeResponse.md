# # PaginatedResponseOfMembershipsV2MembershipTypeResponse
...
**data** | [**\CompWright\ServiceTitan\Model\MembershipsV2MembershipTypeResponse[]**](MembershipsV2MembershipTypeResponse.md) | The collection of result items, will never have more than PageSize items |
