# # PaginatedResponseOfMembershipsV2LocationRecurringServiceResponse
...
**data** | [**\CompWright\ServiceTitan\Model\MembershipsV2LocationRecurringServiceResponse[]**](MembershipsV2LocationRecurringServiceResponse.md) | The collection of result items, will never have more than PageSize items |
