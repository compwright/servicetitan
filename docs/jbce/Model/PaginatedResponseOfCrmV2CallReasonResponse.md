# # PaginatedResponseOfCrmV2CallReasonResponse
...
**data** | [**\CompWright\ServiceTitan\Model\CrmV2CallReasonResponse[]**](CrmV2CallReasonResponse.md) | The collection of result items, will never have more than PageSize items |
