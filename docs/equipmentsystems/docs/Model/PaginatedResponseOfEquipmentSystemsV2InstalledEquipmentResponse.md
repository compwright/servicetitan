# # PaginatedResponseOfEquipmentSystemsV2InstalledEquipmentResponse
...
**data** | [**\CompWright\ServiceTitan\Model\EquipmentSystemsV2InstalledEquipmentResponse[]**](EquipmentSystemsV2InstalledEquipmentResponse.md) | The collection of result items, will never have more than PageSize items |
