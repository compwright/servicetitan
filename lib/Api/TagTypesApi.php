...
class TagTypesApi
{
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['tagTypesGetList'] to see the possible values for this operation
     *
     ...
     */
    public function tagTypesGetList($tenant, $page = null, $page_size = null, $include_total = null, $active = null, string $contentType = self::contentTypes['tagTypesGetList'][0])
    {
        list($response) = $this->tagTypesGetListWithHttpInfo($tenant, $page, $page_size, $include_total, $active, $contentType);
        return $response;
    }
     ...
     */
    public function tagTypesGetListWithHttpInfo($tenant, $page = null, $page_size = null, $include_total = null, $active = null, string $contentType = self::contentTypes['tagTypesGetList'][0])
    {
        $request = $this->tagTypesGetListRequest($tenant, $page, $page_size, $include_total, $active, $contentType);
            ...
            switch($statusCode) {
                case 200:
                    if ('\CompWright\ServiceTitan\Model\PaginatedResponseOfTenantSettingsV2TagTypeResponse' === '\SplFileObject') {
                        ...
                        if ('\CompWright\ServiceTitan\Model\PaginatedResponseOfTenantSettingsV2TagTypeResponse' !== 'string') {
                            try {
     ...
     */
    public function tagTypesGetListAsync($tenant, $page = null, $page_size = null, $include_total = null, $active = null, string $contentType = self::contentTypes['tagTypesGetList'][0])
    {
        return $this->tagTypesGetListAsyncWithHttpInfo($tenant, $page, $page_size, $include_total, $active, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function tagTypesGetListAsyncWithHttpInfo($tenant, $page = null, $page_size = null, $include_total = null, $active = null, string $contentType = self::contentTypes['tagTypesGetList'][0])
    {
        $returnType = '\CompWright\ServiceTitan\Model\PaginatedResponseOfTenantSettingsV2TagTypeResponse';
        $request = $this->tagTypesGetListRequest($tenant, $page, $page_size, $include_total, $active, $contentType);
     ...
     */
    public function tagTypesGetListRequest($tenant, $page = null, $page_size = null, $include_total = null, $active = null, string $contentType = self::contentTypes['tagTypesGetList'][0])
    {
