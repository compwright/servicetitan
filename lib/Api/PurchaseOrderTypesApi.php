...
class PurchaseOrderTypesApi
{
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['purchaseOrderTypesGetList'] to see the possible values for this operation
     *
     ...
     */
    public function purchaseOrderTypesGetList($tenant, $page = null, $page_size = null, $include_total = null, string $contentType = self::contentTypes['purchaseOrderTypesGetList'][0])
    {
        list($response) = $this->purchaseOrderTypesGetListWithHttpInfo($tenant, $page, $page_size, $include_total, $contentType);
        return $response;
    }
     ...
     */
    public function purchaseOrderTypesGetListWithHttpInfo($tenant, $page = null, $page_size = null, $include_total = null, string $contentType = self::contentTypes['purchaseOrderTypesGetList'][0])
    {
        $request = $this->purchaseOrderTypesGetListRequest($tenant, $page, $page_size, $include_total, $contentType);
            ...
            switch($statusCode) {
                case 200:
                    if ('\CompWright\ServiceTitan\Model\PaginatedResponseOfInventoryV2PurchaseOrderTypeResponse' === '\SplFileObject') {
                        ...
                        if ('\CompWright\ServiceTitan\Model\PaginatedResponseOfInventoryV2PurchaseOrderTypeResponse' !== 'string') {
                            try {
     ...
     */
    public function purchaseOrderTypesGetListAsync($tenant, $page = null, $page_size = null, $include_total = null, string $contentType = self::contentTypes['purchaseOrderTypesGetList'][0])
    {
        return $this->purchaseOrderTypesGetListAsyncWithHttpInfo($tenant, $page, $page_size, $include_total, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function purchaseOrderTypesGetListAsyncWithHttpInfo($tenant, $page = null, $page_size = null, $include_total = null, string $contentType = self::contentTypes['purchaseOrderTypesGetList'][0])
    {
        $returnType = '\CompWright\ServiceTitan\Model\PaginatedResponseOfInventoryV2PurchaseOrderTypeResponse';
        $request = $this->purchaseOrderTypesGetListRequest($tenant, $page, $page_size, $include_total, $contentType);
     ...
     */
    public function purchaseOrderTypesGetListRequest($tenant, $page = null, $page_size = null, $include_total = null, string $contentType = self::contentTypes['purchaseOrderTypesGetList'][0])
    {
