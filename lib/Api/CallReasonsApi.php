...
class CallReasonsApi
{
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['callReasonsGet'] to see the possible values for this operation
     *
     ...
     */
    public function callReasonsGet($tenant, $page = null, $page_size = null, $include_total = null, $active = null, string $contentType = self::contentTypes['callReasonsGet'][0])
    {
        list($response) = $this->callReasonsGetWithHttpInfo($tenant, $page, $page_size, $include_total, $active, $contentType);
        return $response;
    }
     ...
     */
    public function callReasonsGetWithHttpInfo($tenant, $page = null, $page_size = null, $include_total = null, $active = null, string $contentType = self::contentTypes['callReasonsGet'][0])
    {
        $request = $this->callReasonsGetRequest($tenant, $page, $page_size, $include_total, $active, $contentType);
            ...
            switch($statusCode) {
                case 200:
                    if ('\CompWright\ServiceTitan\Model\PaginatedResponseOfCrmV2CallReasonResponse' === '\SplFileObject') {
                        ...
                        if ('\CompWright\ServiceTitan\Model\PaginatedResponseOfCrmV2CallReasonResponse' !== 'string') {
                            try {
     ...
     */
    public function callReasonsGetAsync($tenant, $page = null, $page_size = null, $include_total = null, $active = null, string $contentType = self::contentTypes['callReasonsGet'][0])
    {
        return $this->callReasonsGetAsyncWithHttpInfo($tenant, $page, $page_size, $include_total, $active, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function callReasonsGetAsyncWithHttpInfo($tenant, $page = null, $page_size = null, $include_total = null, $active = null, string $contentType = self::contentTypes['callReasonsGet'][0])
    {
        $returnType = '\CompWright\ServiceTitan\Model\PaginatedResponseOfCrmV2CallReasonResponse';
        $request = $this->callReasonsGetRequest($tenant, $page, $page_size, $include_total, $active, $contentType);
     ...
     */
    public function callReasonsGetRequest($tenant, $page = null, $page_size = null, $include_total = null, $active = null, string $contentType = self::contentTypes['callReasonsGet'][0])
    {
