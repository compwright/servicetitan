...
class MembershipsV2MembershipTypeResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'active' => 'bool',
        'discount_mode' => '\CompWright\ServiceTitan\Model\MembershipsV2MembershipTypeResponseDiscountMode',
        'location_target' => '\CompWright\ServiceTitan\Model\MembershipsV2MembershipTypeResponseLocationTarget',
        'revenue_recognition_mode' => '\CompWright\ServiceTitan\Model\MembershipsV2MembershipTypeResponseRevenueRecognitionMode',
    ...
    protected static array $openAPINullables = [
        ...
        'revenue_recognition_mode' => false,
        'auto_calculate_invoice_templates' => false,
        'use_membership_pricing_table' => false,
        'show_membership_savings' => false,
        'id' => false,
        'created_on' => false,
        'created_by_id' => true,
        'modified_on' => false,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('discount_mode', $data ?? [], null);
        $this->setIfExists('location_target', $data ?? [], null);
        $this->setIfExists('revenue_recognition_mode', $data ?? [], null);
        $this->setIfExists('auto_calculate_invoice_templates', $data ?? [], null);
        $this->setIfExists('use_membership_pricing_table', $data ?? [], null);
        $this->setIfExists('show_membership_savings', $data ?? [], null);
    ...
    */
     ...
     * Gets discount_mode
     *
     * @return \CompWright\ServiceTitan\Model\MembershipsV2MembershipTypeResponseDiscountMode
     */
     ...
     * Sets discount_mode
     *
     * @param \CompWright\ServiceTitan\Model\MembershipsV2MembershipTypeResponseDiscountMode $discount_mode discount_mode
     *
     * @return self
     */
    public function setDiscountMode($discount_mode)
    {
        if (is_null($discount_mode)) {
            throw new \InvalidArgumentException('non-nullable discount_mode cannot be null');
        }
     ...
     *
     * @return \CompWright\ServiceTitan\Model\MembershipsV2MembershipTypeResponseLocationTarget
     */
     ...
     *
     * @param \CompWright\ServiceTitan\Model\MembershipsV2MembershipTypeResponseLocationTarget $location_target location_target
     *
     * @return self
     */
    public function setLocationTarget($location_target)
    {
        if (is_null($location_target)) {
            throw new \InvalidArgumentException('non-nullable location_target cannot be null');
        }
     ...
     *
     * @return \CompWright\ServiceTitan\Model\MembershipsV2MembershipTypeResponseRevenueRecognitionMode
     */
     ...
     *
     * @param \CompWright\ServiceTitan\Model\MembershipsV2MembershipTypeResponseRevenueRecognitionMode $revenue_recognition_mode revenue_recognition_mode
     *
     * @return self
     */
    public function setRevenueRecognitionMode($revenue_recognition_mode)
    {
        if (is_null($revenue_recognition_mode)) {
            throw new \InvalidArgumentException('non-nullable revenue_recognition_mode cannot be null');
        }
    ...
    {
        if (is_null($auto_calculate_invoice_templates)) {
            throw new \InvalidArgumentException('non-nullable auto_calculate_invoice_templates cannot be null');
        }
    ...
    {
        if (is_null($use_membership_pricing_table)) {
            throw new \InvalidArgumentException('non-nullable use_membership_pricing_table cannot be null');
        }
    ...
    {
        if (is_null($show_membership_savings)) {
            throw new \InvalidArgumentException('non-nullable show_membership_savings cannot be null');
        }
