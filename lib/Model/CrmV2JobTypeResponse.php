...
/**
 * CrmV2JobTypeResponse Class Doc Comment
 *
 * @category Class
 * @package  CompWright\ServiceTitan
 * @author   OpenAPI Generator team
 ...
 */
class CrmV2JobTypeResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Crm.V2.JobTypeResponse';
    ...
    */
     ...
     * Sets id
     *
     * @param int $id ID of the job type
     *
     * @return self
     */
     ...
     * Sets modified_on
     *
     * @param \DateTime $modified_on Date/time (in UTC) when job type was last modified
     *
     * @return self
     */
     ...
     * Sets external_data
     *
     * @param \CompWright\ServiceTitan\Model\CrmV2ExternalDataModel[] $external_data List of external data attached to this job type, that corresponds to the application guid provided in the request.
     *
     * @return self
     */
