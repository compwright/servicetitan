...
/**
 * PricebookV2CategoryUpdateRequest Class Doc Comment
 *
 * @category Class
 * @package  CompWright\ServiceTitan
 * @author   OpenAPI Generator team
 ...
 */
class PricebookV2CategoryUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Pricebook.V2.CategoryUpdateRequest';
    ...
    */
     ...
     * Gets category_type
     *
     * @return \CompWright\ServiceTitan\Model\PricebookV2CategoryResponseCategoryType|null
     */
     ...
     * Sets category_type
     *
     * @param \CompWright\ServiceTitan\Model\PricebookV2CategoryResponseCategoryType|null $category_type category_type
     *
     * @return self
     */
    ...
    public function setSkuVideos($sku_videos)
    {
        if (is_null($sku_videos)) {
            throw new \InvalidArgumentException('non-nullable sku_videos cannot be null');
        }
