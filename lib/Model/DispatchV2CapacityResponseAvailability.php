...
class DispatchV2CapacityResponseAvailability implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        'start' => false,
        'end' => false,
        'business_unit_ids' => false,
        'total_availability' => false,
        'open_availability' => false,
        'technicians' => false,
        'is_exceeding_ideal_booking_percentage' => false
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('total_availability', $data ?? [], null);
        $this->setIfExists('open_availability', $data ?? [], null);
        $this->setIfExists('technicians', $data ?? [], null);
        $this->setIfExists('is_exceeding_ideal_booking_percentage', $data ?? [], null);
    }
    ...
    */
    ...
    public function setBusinessUnitIds($business_unit_ids)
    {
        if (is_null($business_unit_ids)) {
            throw new \InvalidArgumentException('non-nullable business_unit_ids cannot be null');
        }
     ...
     *
     * @param float $total_availability Number of jobs that total capacity can allow to be booked during this time frame
     *
     * @return self
     */
    public function setTotalAvailability($total_availability)
    {
        if (is_null($total_availability)) {
            throw new \InvalidArgumentException('non-nullable total_availability cannot be null');
        }
     ...
     *
     * @param float $open_availability Number of remaining jobs that can be booked during this time frame
     *
     * @return self
     */
    public function setOpenAvailability($open_availability)
    {
        if (is_null($open_availability)) {
            throw new \InvalidArgumentException('non-nullable open_availability cannot be null');
        }
    ...
    {
        if (is_null($is_exceeding_ideal_booking_percentage)) {
            throw new \InvalidArgumentException('non-nullable is_exceeding_ideal_booking_percentage cannot be null');
        }
