<?php
/**
 * PayrollV2GrossPayItemsGrossPayItemUpdateRequest
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * PayrollV2GrossPayItemsGrossPayItemUpdateRequest Class Doc Comment
 *
 * @category Class
 * @package  CompWright\ServiceTitan
 * @author   OpenAPI Generator team
 ...
 */
class PayrollV2GrossPayItemsGrossPayItemUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Payroll.V2.GrossPayItems.GrossPayItemUpdateRequest';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['activity_code_id'] === null) {
            $invalidProperties[] = "'activity_code_id' can't be null";
        }
     ...
     * Sets amount
     *
     * @param float $amount Amount of the gross pay item
     *
     * @return self
     */
     ...
     *
     * @param int $activity_code_id The ID of the activity code
     *
     * @return self
     */
    public function setActivityCodeId($activity_code_id)
    {
        if (is_null($activity_code_id)) {
            throw new \InvalidArgumentException('non-nullable activity_code_id cannot be null');
        }
     ...
     * Sets date
     *
     * @param \DateTime $date Date of the gross pay item
     *
     * @return self
     */
