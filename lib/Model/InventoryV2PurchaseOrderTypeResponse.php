...
class InventoryV2PurchaseOrderTypeResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['automatically_receive'] = $data['automatically_receive'] ?? null;
        $this->container['display_to_technician'] = $data['display_to_technician'] ?? null;
        $this->container['impact_to_technician_payroll'] = $data['impact_to_technician_payroll'] ?? null;
        $this->container['allow_technicians_to_send_po'] = $data['allow_technicians_to_send_po'] ?? null;
        $this->container['default_required_date_days_offset'] = $data['default_required_date_days_offset'] ?? null;
        $this->container['skip_weekends'] = $data['skip_weekends'] ?? null;
        $this->container['exclude_tax_from_job_costing'] = $data['exclude_tax_from_job_costing'] ?? null;
    }
