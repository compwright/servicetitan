...
class TaskManagementV2TaskCreateResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['task_number'] = $data['task_number'] ?? null;
        $this->container['customer_name'] = $data['customer_name'] ?? null;
        $this->container['job_number'] = $data['job_number'] ?? null;
        $this->container['refund_issued'] = $data['refund_issued'] ?? null;
        $this->container['description_modified_on'] = $data['description_modified_on'] ?? null;
        $this->container['description_modified_by'] = $data['description_modified_by'] ?? null;
