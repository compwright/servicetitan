...
/**
 * EstimatesV2EstimateItemUpdateResponse Class Doc Comment
 *
 * @category Class
 * @package  CompWright\ServiceTitan
 * @author   OpenAPI Generator team
 ...
 */
class EstimatesV2EstimateItemUpdateResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Estimates.V2.EstimateItemUpdateResponse';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['estimate_id'] === null) {
            $invalidProperties[] = "'estimate_id' can't be null";
        }
     ...
     * Sets estimate_id
     *
     * @param int $estimate_id estimate_id
     *
     * @return self
     */
