...
/**
 * CrmV2RemoveBulkTagsRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class CrmV2RemoveBulkTagsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Crm.V2.RemoveBulkTagsRequest';
    ...
    */
     ...
     * Sets customer_ids
     *
     * @param int[] $customer_ids List of Customer ID(s)
     *
     * @return self
     */
     ...
     * Sets tag_type_ids
     *
     * @param int[] $tag_type_ids List of TagType ID(s) to add to the customers
     *
     * @return self
     */
