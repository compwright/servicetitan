    ...
    */
    ...
    public function setAppliedTo($applied_to)
    {
        if (is_null($applied_to)) {
            throw new \InvalidArgumentException('non-nullable applied_to cannot be null');
        }
    ...
    public function setAppliedAmount($applied_amount)
    {
        if (is_null($applied_amount)) {
            array_push($this->openAPINullablesSetToNull, 'applied_amount');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('applied_amount', $nullablesSetToNull);
            if ($index !== FALSE) {
    ...
    public function setAppliedOn($applied_on)
    {
        if (is_null($applied_on)) {
            array_push($this->openAPINullablesSetToNull, 'applied_on');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('applied_on', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
