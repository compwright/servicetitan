...
/**
 * CrmV2HoldJobRequest Class Doc Comment
 *
 * @category Class
 * @package  CompWright\ServiceTitan
 * @author   OpenAPI Generator team
 ...
 */
class CrmV2HoldJobRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Crm.V2.HoldJobRequest';
     ...
     * Sets reason_id
     *
     * @param int $reason_id ID of job hold reason
     *
     * @return self
     */
     ...
     * Sets memo
     *
     * @param string $memo Memo of job hold reason
     *
     * @return self
     */
