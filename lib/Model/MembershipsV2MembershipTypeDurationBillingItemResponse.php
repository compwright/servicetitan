...
class MembershipsV2MembershipTypeDurationBillingItemResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'id' => 'int',
        'duration' => 'int',
        'billing_frequency' => '\CompWright\ServiceTitan\Model\MembershipsV2MembershipTypeDurationBillingItemResponseBillingFrequency',
        'sale_price' => 'float',
        'billing_price' => 'float',
        'renewal_price' => 'float',
        'import_id' => 'string',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('billing_price', $data ?? [], null);
    ...
    */
     ...
     *
     * @return \CompWright\ServiceTitan\Model\MembershipsV2MembershipTypeDurationBillingItemResponseBillingFrequency
     */
     ...
     *
     * @param \CompWright\ServiceTitan\Model\MembershipsV2MembershipTypeDurationBillingItemResponseBillingFrequency $billing_frequency billing_frequency
     *
     * @return self
     */
    ...
    {
        if (is_null($billing_price)) {
            throw new \InvalidArgumentException('non-nullable billing_price cannot be null');
        }
