...
class InventoryV2UpdateVendorRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Gets address
     *
     * @return OneOfInventoryV2AddressRequest|null
     */
     ...
     * Sets address
     *
     * @param OneOfInventoryV2AddressRequest|null $address Address
     *
     * @return self
     */
     ...
     * Sets external_data
     *
     * @param OneOfInventoryV2ExternalDataUpdateRequest|null $external_data Contains a list of external data items that should be attached to this vendor
     *
     * @return self
     */
