...
/**
 * InventoryV2UpdateVendorRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class InventoryV2UpdateVendorRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Inventory.V2.UpdateVendorRequest';
    ...
    protected static $openAPITypes = [
        ...
        'delivery_option' => '\CompWright\ServiceTitan\Model\InventoryV2UpdateVendorRequestDeliveryOption',
        'tax_rate' => 'float',
        ...
        'vendor_contacts' => '\CompWright\ServiceTitan\Model\InventoryV2UpdateVendorContactRequest[]',
        'external_data' => '\CompWright\ServiceTitan\Model\InventoryV2UpdateVendorRequestExternalData'
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'vendor_quickbooks_item' => false,
        'payment_term_id' => false,
        'remittance_vendor_id' => false,
        'address' => false,
        'tags' => false,
    ...
    */
     ...
     *
     * @param bool|null $is_truck_replenishment Replenishment Vendor
     *
     * @return self
     */
     ...
     *
     * @return \CompWright\ServiceTitan\Model\InventoryV2UpdateVendorRequestDeliveryOption|null
     */
     ...
     *
     * @param \CompWright\ServiceTitan\Model\InventoryV2UpdateVendorRequestDeliveryOption|null $delivery_option delivery_option
     *
     * @return self
     */
     ...
     * Sets tax_rate
     *
     * @param float|null $tax_rate Default Tax Rate
     *
     * @return self
     */
     ...
     *
     * @param bool|null $restricted_mobile_creation Restrict PO Creation in Mobile
     *
     * @return self
     */
    ...
    public function setVendorQuickbooksItem($vendor_quickbooks_item)
    {
        if (is_null($vendor_quickbooks_item)) {
            throw new \InvalidArgumentException('non-nullable vendor_quickbooks_item cannot be null');
        }
    ...
    public function setPaymentTermId($payment_term_id)
    {
        if (is_null($payment_term_id)) {
            throw new \InvalidArgumentException('non-nullable payment_term_id cannot be null');
        }
    ...
    public function setRemittanceVendorId($remittance_vendor_id)
    {
        if (is_null($remittance_vendor_id)) {
            throw new \InvalidArgumentException('non-nullable remittance_vendor_id cannot be null');
        }
     ...
     * Gets address
     *
     * @return \CompWright\ServiceTitan\Model\InventoryV2CreateVendorRequestAddress|null
     */
     ...
     * Sets address
     *
     * @param \CompWright\ServiceTitan\Model\InventoryV2CreateVendorRequestAddress|null $address address
     *
     * @return self
     */
     ...
     *
     * @return \CompWright\ServiceTitan\Model\InventoryV2UpdateVendorContactRequest[]|null
     */
     ...
     *
     * @param \CompWright\ServiceTitan\Model\InventoryV2UpdateVendorContactRequest[]|null $vendor_contacts Email Recipients
     *
     * @return self
     */
    public function setVendorContacts($vendor_contacts)
    {
        if (is_null($vendor_contacts)) {
            throw new \InvalidArgumentException('non-nullable vendor_contacts cannot be null');
        }
     ...
     * Gets external_data
     *
     * @return \CompWright\ServiceTitan\Model\InventoryV2UpdateVendorRequestExternalData|null
     */
     ...
     * Sets external_data
     *
     * @param \CompWright\ServiceTitan\Model\InventoryV2UpdateVendorRequestExternalData|null $external_data external_data
     *
     * @return self
     */
