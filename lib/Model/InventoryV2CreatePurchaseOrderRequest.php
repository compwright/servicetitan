...
class InventoryV2CreatePurchaseOrderRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'technician_id' => 'int',
        'project_id' => 'int',
        'ship_to' => '\CompWright\ServiceTitan\Model\InventoryV2CreatePurchaseOrderRequestShipTo',
    ...
    */
     ...
     * Gets ship_to
     *
     * @return \CompWright\ServiceTitan\Model\InventoryV2CreatePurchaseOrderRequestShipTo
     */
     ...
     * Sets ship_to
     *
     * @param \CompWright\ServiceTitan\Model\InventoryV2CreatePurchaseOrderRequestShipTo $ship_to ship_to
     *
     * @return self
     */
    ...
    public function setVendorInvoiceNumber($vendor_invoice_number)
    {
        if (is_null($vendor_invoice_number)) {
            array_push($this->openAPINullablesSetToNull, 'vendor_invoice_number');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('vendor_invoice_number', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
