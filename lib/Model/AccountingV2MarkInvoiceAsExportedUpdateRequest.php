...
class AccountingV2MarkInvoiceAsExportedUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('external_message', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($external_message)) {
            array_push($this->openAPINullablesSetToNull, 'external_message');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('external_message', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
